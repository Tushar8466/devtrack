        ...
        <div className="w-full py-24 px-6 relative">
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-center justify-between mb-16 sm:mb-20 gap-8">
                    ...
                    <div className="w-full sm:w-auto bg-white/5 border border-white/10 px-6 py-4 rounded-2xl flex items-center justify-center sm:justify-start gap-6 backdrop-blur-md">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    {feedbacks.map((f, i) => (
                        <motion.div
                            ...
                            className="group relative bg-[#050505] border border-white/10 rounded-4xl sm:rounded-[2.5rem] p-6 sm:p-8 hover:border-violet-500/30 transition-all duration-700 hover:bg-black/80 flex flex-col justify-between shadow-2xl overflow-hidden min-h-[300px] sm:min-h-[320px]"
                        >
                            ...
                            <div>
                                <div className="flex items-center gap-4 mb-6 sm:mb-8">
                                    <div className="relative">
                                        ...
                                        <div className="relative w-10 h-10 sm:w-12 sm:h-12 rounded-full border border-white/10 overflow-hidden bg-white/5 flex items-center justify-center p-0.5">
                                            {f.avatar ? (
                                                ...
                                                <User size={18} className="text-neutral-700 group-hover:text-violet-400 transition-colors" />
                                            )}
                                        </div>
                                    </div>
                                    <div className="text-left">
                                        <div className="text-[10px] sm:text-[11px] font-black text-white uppercase tracking-tight leading-none mb-1.5 group-hover:text-violet-400 transition-colors">{f.author}</div>
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-[8px] sm:text-[9px] font-mono text-neutral-600 uppercase tracking-widest font-bold">
                                ...
                                <blockquote className="text-neutral-400 text-xs sm:text-[13px] leading-relaxed mb-6 sm:mb-8 italic font-medium group-hover:text-neutral-300 transition-colors border-l-2 border-white/5 pl-4 py-1">
                                    "{f.content}"
                                </blockquote>
                            </div>

                            <div className="pt-4 sm:pt-6 border-t border-white/5 flex items-center justify-between opacity-30 group-hover:opacity-80 transition-opacity">
                                <div className="flex items-center gap-2">
                                    <MessageSquare size={10} className="text-neutral-600" />
                                    <span className="text-[8px] sm:text-[9px] font-mono text-neutral-700 uppercase tracking-[0.2em]">#SEQ_{String(f.id).slice(-4)}</span>
                                </div>
